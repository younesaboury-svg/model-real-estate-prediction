...
def get_localisations_location(cat: str) -> list:
    """Retourne la liste réelle des quartiers connus pour la catégorie de location."""
    stats = load_loc_dashboard_stats()
    if stats:
        return stats.get(f"{cat}_localisations", ["Autre"])
    return ["Autre"]
...
def render_location_estimator() -> None:
    ...
    if categorie_choice == "villas":
        ...
        with c2:
            ...
            localisation = st.selectbox("Localisation", get_localisations_location("villas"), key="loc_v_loc")
        ...
        localisation = st.selectbox("Localisation", get_localisations_location("maisons"), key="loc_m_loc")
        ...
        localisation = st.selectbox("Localisation", get_localisations_location("bureaux"), key="loc_b_loc")
        ...
        localisation = st.selectbox("Localisation", get_localisations_location("appartements"), key="loc_a_loc")
        ...
        localisation = st.selectbox("Localisation", get_localisations_location("magasins"), key="loc_mg_loc")
        ...
        localisation = st.selectbox("Localisation", get_localisations_location("riads"), key="loc_r_loc")
